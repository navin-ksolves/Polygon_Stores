...
_logger = logging.getLogger("Conversion Engine - Product Controller")

class ProductController(http.Controller):

    @http.route('/webhook_cengine/product', type='json', auth='public', methods=['POST'], csrf=False)
    def create_product_webhook(self):
        ...
        _logger.info('Webhook for products received - %s', data)
