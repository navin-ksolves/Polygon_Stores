odoo.define('graph_widget_ept.graph', function (require) {
    ...
    var pragtechDashboardGraph = AbstractField.extend({
    ...
    fieldRegistry.add('dashboard_graph_ept', pragtechDashboardGraph);
    return {
        pragtechDashboardGraph: pragtechDashboardGraph
    };
});